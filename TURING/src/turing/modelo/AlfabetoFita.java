...
import static turing.programa.Tokens.SIMBOLO_DELIMITADOR;

/**
 * Classe que representa o Alfabeto da fita (Γ). O alfabeto da fita contém o alfabeto 
 * de entrada (Σ), o alfabeto auxiliar (V), mais todos os símbolos reservados, 
 * como o símbolo de branco (β) e o símbolo de delimitador de seções (#). É o total
 * de símbolos que podem ser inscritos na(s) fita(s) da máquina de Turing.
 * 
...
public class AlfabetoFita extends Alfabeto {
    ...
    /**
     * Obter os símbolos reservados (Branco e delimitador).
     * 
    ...
    /**
     * Obter o símbolo com base na caractere ASCII que o representa.
     * @param caractere caractere ASCII do símbolo.
     * @return símbolo relacionado com o caractere ASCII.
     */
    @Override
