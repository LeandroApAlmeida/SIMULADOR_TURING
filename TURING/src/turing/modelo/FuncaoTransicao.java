...
public class FuncaoTransicao implements Iterable<Transicao> {
    ...
    /**
     * Adicionar uma transição. Não permite que uma mesma transição seja inserida
     * mais do que uma vez. Exemplo: q0, a = q1, b, D. Neste caso, a transição
     * está definida, e não deve ser inserida novamente.
     * 
