...
public class Transicao {
    ...
    /**Parâmetros para a Cabeça de Leitura/Escrita.*/
    private final List<ParametrosCabeca> parametrosFita;
     ...
     * 
     * @param novoEstado estado final da transição.
     * 
     * @param parametrosFita Parâmetros de leitura/escrita da fita e movimento
     * da Cabeça de Leitura/Escrita. 
     */
    public Transicao(Estado estadoInicial, Estado novoEstado, 
    List<ParametrosCabeca> parametrosFita) {
     ...
     */
    public List<ParametrosCabeca> getParametrosFita() {
    ...
    public String toString() {
        ...
        for (int i = 0; i < parametrosFita.size(); i++) {
            ...
            char caractere = parametrosFita.get(i).getSimboloLido().getCaracter();
            
            switch (caractere) {
                case ' ' -> simbolo = SIMBOLO_ESPACO;
                case ',' -> simbolo = SIMBOLO_VIRGULA;
                default -> simbolo = new String(new char[]{caractere});
            }
        ...
        sb.append(novoEstado.getRotulo());
        ...
        for (int i = 0; i < parametrosFita.size(); i++) {
            ...
            char caractere = parametrosFita.get(i).getSimboloEscrito().getCaracter();
