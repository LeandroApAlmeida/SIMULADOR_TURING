...
/**
 * Classe que representa uma fita da Máquina de Turing. Uma fita é um arranjo de 
 * células e pode ser infinita à esquerda e à direita, finita à esquerda e infinita
 * à direita, ou finita à esquerda e à direita, dependendo do modelo de máquina 
 * de Turing implementado. Neste simulador o modelo adotado será o de fita infinita
 ...
 * centro de um arranjo idexado por integer - a metade do "infinito", o mesmo é
 * feito com o arranjo real, estabelecendo uma célula pivô aonde o cursor inicializa 
...
public final class Fita {
    ...
    /**
     * Redimensionar a fita, adicionando células em uma direção nas extremidades.
     * 
     * @param posicao posição atual do cursor.
     * 
     * @param qtdCelulas quantidade de células a adicionar.
     * 
     * @param direcao direção a ser adicionadas as células. Valor 1, adiciona
     * células à direita. Valor -1, adiciona células à esquerda.
     * 
     * @return Se true, a fita foi redimensionada. Se false, a fita não foi
     * redimensionada.
     */
    public boolean redimensionar(int posicao, int qtdCelulas, int direcao) {
        
        if (qtdCelulas > 0) {
            
            int pos = getEnderecoAbsoluto(posicao);

            Simbolo[] celulasTmp = new Simbolo[celulas.length + qtdCelulas];
            ...
            switch (direcao) {
                ...
                case 1 -> {
                    ...
                    System.arraycopy(celulas, 0, celulasTmp, 0 , ref);
                    
                    for (int i = ref; i < ref + qtdCelulas; i++) {
                        celulasTmp[i] = alfabetoFita.getSimboloBranco();
                    }  
                    ...
                    if (celulaPivo > posicao) {
                        celulaPivo = celulaPivo + qtdCelulas;
                    }
                ...
                case -1 -> {
                    ...
                    System.arraycopy(celulas, 0, celulasTmp, 0, pos);
                    
                    int ref = pos + qtdCelulas;
