...
import static turing.modelo.DirecaoMovimento.DIREITA;
import static turing.modelo.DirecaoMovimento.ESQUERDA;

/**
 * Classe que implementa um modelo de Máquina de Turing com Múltiplas Fitas. O
 * modelo com múltiplas fitas adotado tem uma Unidade de Controle, e para cada fita,
 * uma Cabeça de Leitura/Escrita. Cada fita do modelo é infinita à direita e
 * à esquerda. Baseado na literatura sobre o tema, este é o modelo que mais se
 * aproxima de um computador real com relação à capacidade de programação, e é
 * esta a característica mais relavante do ponto de vista do projeto.
 * 
 * <br><br>
 * 
 * <p align="center">
 ...
 * <br>
 * 
 * Vale ressaltar que o modelo adotado, com múltiplas fitas, e cada fita sendo
 * infinita à direita e à esquerda, pode ser simulado com uma Máquina de Turing
 * Padrão, com uma única fita, finita à esquerda e infinita à direita. Na prática,
 * ambas as máquinas são equivalentes, com a diferença que o modelo adotado neste
 * trabalho roda o programa de modo mais eficiente, e mais próximo de uma máquina
 * real.
 * 
 * <br><br>
 * 
 ...
 * <br><br>
 * 
 * <b>β</b> Símbolo especial branco (ou vazio);
 * 
 * <br><br>
 * 
 * <b>*</b> Símbolo especial delimitador de seção.
 * 
 * </BLOCKQUOTE>
 * 
 * <br>
 ...
 * @since 1.0
 */
public class MaquinaMultifitas extends MaquinaTuring {
    
    
    /**Ouvintes da simulação da máquina de Turing.*/
    private final List<OuvinteSimulacao> ouvintes;
     ...
     */
    public MaquinaMultifitas(String nome, AlfabetoFita alfabetoFita, 
    ConjuntoEstados conjuntoEstados, FuncaoTransicao funcaoTransicao,int numeroFitas) 
    throws Exception {
        
        super(nome, alfabetoFita,conjuntoEstados, funcaoTransicao, numeroFitas);
     ...
     * 
     * @throws Exception exceção lançada em caso de símbolos inválidos na
     * palavra de entrada.
     */
    public void carregarPalavra(String palavra) throws Exception {
        ...
        for (int i = 0; i < palavra.length(); i++) {
            ...
            Simbolo simbolo = alfabetoEntrada.getSimbolo(palavra.charAt(i));
    ...
    public void executarPasso() {
        ...
        if (emExecucao) {
            ...
            if (transicao != null) {
                ...
                List<ParametrosCabeca> paramsFita = transicao.getParametrosFita();

                for (int i = 0; i < paramsFita.size(); i++) {
                    
                    ParametrosCabeca params = paramsFita.get(i);
     ...
     */
    public boolean removerOuvinte(OuvinteSimulacao ouvinte) {
