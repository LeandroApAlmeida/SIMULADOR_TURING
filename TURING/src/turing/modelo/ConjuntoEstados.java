...
/**
 * Classe que representa o conjunto de estados da máquina de Turing (Q). Pertence
 * ao conjunto dos estados o estado inicial (q<sub>0</sub>) e o conjunto dos estados
 * terminais (F) e não terminais.
 * 
...
public class ConjuntoEstados extends ListaEstados {
    ...
    /**
     * Definir o estado inicial. Somente um estado pode ter este status. Se houver
     * um estado inicial marcado anteriormente, desmarca.
     * 
